            ...
            <div className="page-wrap">
                ...
                <footer className="footer">
                    <div className="w-100 clearfix">
                        ...
                        <span className="float-none float-sm-right mt-1 mt-sm-0 text-center">Crafted with <i className="fa fa-heart text-danger"></i> by <a href="http://lavalite.org/" className="text-dark" target="_blank">Lavalite</a></span>
                    </div>
                </footer>
